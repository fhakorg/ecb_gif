...
# Generate a random 16-byte key and 16-byte IV for AES-CBC
key = os.urandom(16)
iv = os.urandom(16)

with open('aes_cbc_key.bin', 'wb') as key_file:
    key_file.write(key + iv)  # Save key and IV together
print("Encryption key and IV saved as 'aes_cbc_key.bin'")
...
encrypted_img.save('cbc_penguin.png')
print("Encrypted image saved as 'cbc_penguin.png'")
