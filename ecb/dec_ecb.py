...
# Create a new image with extended background (white)
...
# Convert padded image to raw bytes (RGB pixels)
...
# Convert pixel data to numpy arrays for interpolation
